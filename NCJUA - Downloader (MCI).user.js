...
// @updateURL  https://raw.githubusercontent.com/Synth6/Tamper-Monkey-V2/main/NCJUA%20-%20Downloader%20(MCI).user.js
// @downloadURL  https://raw.githubusercontent.com/Synth6/Tamper-Monkey-V2/main/NCJUA%20-%20Downloader%20(MCI).user.js
// ==/UserScript==
...
(function () {
  ...
  function getPolicyFileTables() {
    // This avoids scanning the whole page and avoids the 147 â€œrowsâ€
  ...
  function mountUI() {
    ...
    body.appendChild(btn('Stop', function () {
      stopFlag = true;
      updateStat('<span style="color:#ffcc80;"><b>Stoppingâ€¦</b></span>');
    }));
