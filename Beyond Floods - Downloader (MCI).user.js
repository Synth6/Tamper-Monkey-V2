...
// @grant        none
// @updateURL  https://raw.githubusercontent.com/Synth6/Tamper-Monkey-V2/main/Beyond%20Floods%20-%20Downloader%20(MCI).user.js
// @downloadURL  https://raw.githubusercontent.com/Synth6/Tamper-Monkey-V2/main/Beyond%20Floods%20-%20Downloader%20(MCI).user.js
// ==/UserScript==
...
(function () {
  ...
  async function downloadSelected() {
    ...
    setStatus('Starting downloads: ' + selected.length + ' file(s)â€¦');
    ...
    for (var j = 0; j < selected.length; j++) {
      ...
      setStatus('(' + (j + 1) + '/' + selected.length + ') ' + (a2.textContent || 'Downloadingâ€¦'));
