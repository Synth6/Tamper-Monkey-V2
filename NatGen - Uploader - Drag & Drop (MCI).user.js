...
// @updateURL  https://raw.githubusercontent.com/Synth6/Tamper-Monkey-V2/main/NatGen%20-%20Uploader%20-%20Drag%20&%20Drop%20(MCI).user.js
// @downloadURL  https://raw.githubusercontent.com/Synth6/Tamper-Monkey-V2/main/NatGen%20-%20Uploader%20-%20Drag%20&%20Drop%20(MCI).user.js
// ==/UserScript==
  ...
  function buildDropUI(popup) {
    ...
    function renderSelectedList() {
      ...
      if (selectedFiles.length) {
        ...
        dz.textContent = selectedFiles.length + ' selected â€” drop more to add (max ' + MAX_FILES + ')';
      } else {
