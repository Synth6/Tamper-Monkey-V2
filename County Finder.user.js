...
(function () {
  ...
  const GEOCODIFY_API_KEY = 'GET_YOUR_OWN_API_CODE';
  ...
  function openManualEntryBox(initialValue) {
    ...
    Object.assign(box.style, {
      ...
      borderRadius: '10px',
      background: 'linear-gradient(180deg,#e8f4fd 0%,#d3e9f9 100%)',
      border: '1px solid rgba(60,120,180,.35)',
    ...
    Object.assign(cancelBtn.style, {
      border: '1px solid rgba(15,42,58,.18)',
      background: '#475569',
      color: '#ffffff',
      borderRadius: '8px',
      fontSize: '12px',
    ...
    Object.assign(runBtn.style, {
      border: '1px solid rgba(30,70,110,.18)',
      background: 'linear-gradient(180deg,#3da3e6 0%,#1f6fb2 100%)',
      color: '#ffffff',
      borderRadius: '8px',
      fontSize: '12px',
      fontWeight: '700',
