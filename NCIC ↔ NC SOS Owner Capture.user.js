...
// @updateURL  https://raw.githubusercontent.com/Synth6/Tamper-Monkey-V2/main/NCIC%20↔%20NC%20SOS%20Owner%20Capture.user.js
// @downloadURL  https://raw.githubusercontent.com/Synth6/Tamper-Monkey-V2/main/NCIC%20↔%20NC%20SOS%20Owner%20Capture.user.js
// ==/UserScript==
...
(function () {
  ...
  // ---------------------------------------------
  // PART 1: NCIC APP SIDE â€“ click SOS button
  // ---------------------------------------------
  if (isNcicApp) {
    (async () => {
  ...
  // ---------------------------------------------
  // PART 2: SOS SEARCH PAGE â€“ prefill + search
  // ---------------------------------------------
  if (isSosSearch) {
    (async () => {
      if (!(await isEnabled())) {
  ...
  // ---------------------------------------------------
  // PART 3: SOS RESULTS â€“ you click company, we click
  ...
  // ---------------------------------------------------
  // PART 4: SOS PROFILE PAGE â€“ scrape owners + address
